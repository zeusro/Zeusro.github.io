...
OCI全称[Open Container Initiative](https://opencontainers.org/)隶属于Linux基金会，是Docker, CoreOS联合其他容器厂商，于2015-6-22建立的一个开源组织。其目的主要是为了制定容器技术的通用技术标准。
